...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rest_registration_registrationprofile', (
        ...
        db.send_create_signal(u'rest_registration', ['RegistrationProfile'])


    def backwards(self, orm):
        # Deleting model 'RegistrationProfile'
        db.delete_table(u'rest_registration_registrationprofile')
    ...
    models = {
        ...
        u'registration.registrationprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.User']", 'unique': 'True'})
        },
        u'rest_registration.registrationprofile': {
    ...
    complete_apps = ['rest_registration']