...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flavor.variable_storage_available'
        db.add_column(u'api_flavor', 'variable_storage_available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Flavor.variable_storage_default'
        db.add_column(u'api_flavor', 'variable_storage_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Flavor.fixed_storage'
        db.add_column(u'api_flavor', 'fixed_storage',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


        # Changing field 'HistoricalNode.storage'
        db.alter_column(u'api_historicalnode', 'storage', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Node.storage'
        db.alter_column(u'api_node', 'storage', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Flavor.variable_storage_available'
        db.delete_column(u'api_flavor', 'variable_storage_available')

        # Deleting field 'Flavor.variable_storage_default'
        db.delete_column(u'api_flavor', 'variable_storage_default')

        # Deleting field 'Flavor.fixed_storage'
        db.delete_column(u'api_flavor', 'fixed_storage')


        # User chose to not deal with backwards NULL issues for 'HistoricalNode.storage'
        raise RuntimeError("Cannot reverse this migration. 'HistoricalNode.storage' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'HistoricalNode.storage'
        db.alter_column(u'api_historicalnode', 'storage', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'Node.storage'
        raise RuntimeError("Cannot reverse this migration. 'Node.storage' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Node.storage'
        db.alter_column(u'api_node', 'storage', self.gf('django.db.models.fields.IntegerField')())
