...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CreditCardToken'
        db.create_table(u'api_creditcardtoken', (
            ('id', self.gf(u'django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'creditcards', to=orm['api.User'])),
            ('token', self.gf('django.db.models.fields.CharField')(default=u'', max_length=40, blank=True)),
            ('valid_until', self.gf('django.db.models.fields.DateField')()),
            ('type', self.gf('django.db.models.fields.CharField')(default=u'', max_length=10, blank=True)),
            ('last4', self.gf('django.db.models.fields.CharField')(default=u'', max_length=4, blank=True)),
        ...
        db.send_create_signal(u'api', ['CreditCardToken'])

        # Adding model 'Pricing'
        db.create_table(u'api_pricing', (
            ('uuid', self.gf(u'django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'pricing', to=orm['api.Region'])),
            ('flavor', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'pricing', to=orm['api.Flavor'])),
            ('cost', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=4)),
        ))
        db.send_create_signal(u'api', ['Pricing'])

        # Adding unique constraint on 'Pricing', fields ['region', 'flavor']
        db.create_unique(u'api_pricing', ['region_id', 'flavor_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Pricing', fields ['region', 'flavor']
        db.delete_unique(u'api_pricing', ['region_id', 'flavor_id'])

        # Deleting model 'CreditCardToken'
        db.delete_table(u'api_creditcardtoken')

        # Deleting model 'Pricing'
        db.delete_table(u'api_pricing')
