...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'api_backup', 'size', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'Backup.size'
        db.alter_column(u'api_backup', 'size', self.gf('django.db.models.fields.PositiveIntegerField')())
