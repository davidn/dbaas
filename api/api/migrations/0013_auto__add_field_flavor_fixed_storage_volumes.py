...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flavor.fixed_storage_volumes'
        db.add_column(u'api_flavor', 'fixed_storage_volumes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flavor.fixed_storage_volumes'
        db.delete_column(u'api_flavor', 'fixed_storage_volumes')
