...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Provider.launch_time'
        db.add_column(u'api_provider', 'launch_time',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Provider.launch_time'
        db.delete_column(u'api_provider', 'launch_time')
