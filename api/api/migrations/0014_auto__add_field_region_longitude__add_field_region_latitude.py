...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'api_region', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Region.latitude'
        db.add_column(u'api_region', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'api_region', 'longitude')

        # Deleting field 'Region.latitude'
        db.delete_column(u'api_region', 'latitude')
    ...
    models = {
        ...
        u'api.node': {
            ...
            'tinc_private_key': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'})
        },
        u'api.provider': {
