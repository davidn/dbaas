...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rule'
        db.create_table(u'api_rule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('condition', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'api', ['Rule'])

        # Adding M2M table for field completed on 'Rule'
        m2m_table_name = db.shorten_name(u'api_rule_completed')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rule', models.ForeignKey(orm[u'api.rule'], null=False)),
            ('user', models.ForeignKey(orm[u'api.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['rule_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'Rule'
        db.delete_table(u'api_rule')

        # Removing M2M table for field completed on 'Rule'
        db.delete_table(db.shorten_name(u'api_rule_completed'))
