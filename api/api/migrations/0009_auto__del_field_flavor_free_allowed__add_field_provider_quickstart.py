...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Provider.quickstart'
        db.add_column(u'api_provider', 'quickstart',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', null=True, on_delete=models.PROTECT, to=orm['api.Flavor']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Provider.quickstart'
        db.delete_column(u'api_provider', 'quickstart_id')
