...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_activity', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'activity', to=orm['api.User'])),
            ('action', self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, blank=True)),
            ('detail', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
